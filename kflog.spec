...
Summary(pl):	KFLog jest programem logowania lotu dla pilot� szybowc�
Name:		kflog
Version:	2.1.1
Release:	0.2
License:	GNU
...
%description -l pl
KFLog jest opensource'owym programem przeznaczonym dla pilot�
szybowc�. Daje potene narz�zie do planowania lotu prze lotem
oraz analizy lotu ju po. KFLog jest jedynym analizatorem lotu
dost�nym dla Linuxa rozpoznawanym przez FAI IGC. KFLog prezentuje
lot na cyfrowej mapie, kt�e zawiera nie tylko lotniska i strefy
przestrzeni lotniczej, ale take kompletn mape wysokociow,
drogi, miasta, rzeki oraz sporo innych interesujcych obiekt�.
